...
df = pd.read_csv('pydb.csv', header=0, index_col=0)
...
df_cleaned[['age', 'bmi', 'avg_glucose_level']] = scaler.fit_transform(df_cleaned[['age', 'bmi', 'avg_glucose_level']])
...
# Affichage des graphiques en fonction du menu
